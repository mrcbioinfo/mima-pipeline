...
- **Reference databases**
  ...
  - See [Requirements]({{site.baseurl}}/requirements) for details regarding reference databases
...
<tr>
  ...
  <td rowspan=4 style="width:40%"><img src="{{site.baseurl}}/assets/img/tutorials/no-singularity/tut_OverallSchema.png"/></td>
</tr>
...
2. Check [Requirements](requirements): reference data are met - remember to take note of the paths to the reference databases
...
<tr>
  ...
  <td rowspan=5 style="width:40%"><img src="{{site.baseurl}}/assets/img/tutorials/no-singularity/tut_QCpipeline.png"/></td>
</tr>
...
<td rowspan=3 style="width:40%"><img src="{{site.baseurl}}/assets/img/tutorials/no-singularity/tut_TAXApipeline.png"/></td>
</tr>
...
<td rowspan=2 style="width:40%"><img src="{{site.baseurl}}/assets/img/tutorials/no-singularity/tut_function_pipeline.png"/></td>
</tr>
