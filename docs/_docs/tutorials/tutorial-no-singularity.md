...
![]({{site.baseurl}}/assets/img/tutorials/pipeline/tut_OverallSchema.png)
...
![QC PBS pipeline]({{site.baseurl}}/assets/img/tutorials/pipeline/tut_QCpipeline.png)
...
![Taxonomy PBS script mini-pipeline using Kraken2 classifier]({{site.baseurl}}/assets/img/tutorials/pipeline/tut_TAXApipeline.png)
...
![Function mini-pipeline]({{site.baseurl}}/assets/img/tutorials/pipeline/tut_function_pipeline.png)
