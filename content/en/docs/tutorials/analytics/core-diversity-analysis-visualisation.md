...
You can skip this section if you have already run the [Biodiversity bar plot tutorial](../biodiversity-bar-plots) and go directly to [Step 2-to refresh yourself with the data](#step-2-quick-look-at-input-files) or proceed to [Step 3-running the analysis.](#step-3-run-core-diversity-analysis)
{{% /alert %}}

  - Use the `vis-tutorial` directory from [Biodiversity bar plots](../biodiversity-bar-plots) or create a directory `vis-tutorial`
...
{{< card header="**Comparing Observed Richness between Labs**" 
  ...
  <img src="/images/tutorials/visualisation/observed_lab_dotplot.png"/>
{{< /card >}}
...
{{< card header="**Comparing Evenness between Labs**" 
  ...
  <img src="/images/tutorials/visualisation/evenness_lab_dotplot.png"/>
{{< /card >}}
{{< /cardpane >}}
