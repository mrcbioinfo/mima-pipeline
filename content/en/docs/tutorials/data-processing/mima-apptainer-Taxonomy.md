...
This pipeline uses Kraken2 and Bracken abundance estimation. Both require access to [reference database](/docs/data-dependencies/#taxonomy-profiling) or you can generate your own reference data. In this pipeline, we will use the [GTDB](https://gtdb.ecogenomic.org/) database (release 95) and have built a Kraken2 database.
...
- Find the [absolute paths](../need-to-know/#use-absolute-paths) for the **Kraken2** and **Bracken** reference databases on your HPC system (**!!** they need to be in the same directory)
...
{{% alert color=info title="Output files explained" %}}
* For details about the Kraken2 output, see their [documentation](https://github.com/DerrickWood/kraken2/wiki/Manual#output-formats)
* For details about the Bracken output, see their [documentation](https://ccb.jhu.edu/software/bracken/index.shtml?t=manual#format)
{{% /alert %}}
...
**Next:** if you haven't already, you can also [generate functional profiles](../mima-apptainer-function) with your shotgun metagenomics data.